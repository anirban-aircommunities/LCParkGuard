        ...
        <View style={styles.outerContainer}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.innerContainer}>
                ...
                <CardView
                    ...
                    cardType="arrow"
                    handleClick={() => props?.navigation?.navigate("UpdateProfile")}
                />
                <View style={styles.gap} />
                <CardView
                    icon={darkMode}
                    ...
                    cardSubtitle={`You can switch to ${isDarkMode ? 'light' : 'dark'} mode here.`}
                    cardType="switch"
                    isEnabled={isDarkMode}
                    setIsEnabled={() => setIsDarkMode(!isDarkMode)}
                />
                <View style={styles.gap} />
                <Text
                    style={[
