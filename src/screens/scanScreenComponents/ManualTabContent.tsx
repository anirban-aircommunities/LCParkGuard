...
const ManualTabContent: React.FC<ManualTabContentProps> = ({ licensePlate, parkingSpot, setLicensePlate, setParkingSpot, setHasAddedToHistory, setHasSentToTowing, setIsScanning, setCapturedImage, setIsProcessing, setInputMethod, setIsTextResidentModalVisible }: any) => {
